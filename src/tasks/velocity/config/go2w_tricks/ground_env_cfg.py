        ...
        "stages": (
          {
            ...
            # The m600 side-clearance seed solved right support but left the
            # mirrored branch drifting.  Give both lateral one-hots equal
            # rollout mass while retaining every normal/front/rear branch.
